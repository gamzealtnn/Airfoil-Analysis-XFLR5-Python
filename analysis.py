...
folder_cambered = 'naca4412_data.txt'
...
df4412 = pd.read_csv(folder_cambered, skiprows=11, sep=r'\s+', names=columns, usecols=range(10))

plt.figure(figsize=(10, 6))

plt.plot(df0012['alpha'], df0012['CL'], 'b-o', label = 'NACA 0012(symmetric)', markersize=4)

plt.plot(df4412['alpha'], df4412['CL'], 'r-s', label = 'NACA 4412 (cambered)', markersize = 4)
